...
(function() {
  var api, arrToObj, camelToDisplay, compositeTypes, data, exclude, fs, getType, handlers, ident, inApi, isComposite, mutateHandlers, notComposite, notEmpty, site, skus,
  ...
  skus.forEach(function(sku) {
    var apiProduct, details, key, product, result, val, videoString;
    apiProduct = api[sku];
    product = {};
    details = {};
